        ...
        <div className="relative max-w-xl pb-16 mx-auto bg-white rounded">
          ...
          <div className="px-20">
            ...
            <Dialog.Description className="text-center mb-7">
                Closing a period means no more quantifications can be performed. A closed period cannot be re-opened.
            </Dialog.Description>
            <div className="flex justify-center">
              <button className="praise-button mt-4" onClick={() => {onRemove(); onClose();}}>
                <FontAwesomeIcon className="mr-2" icon={faTimesCircle} size="1x" />
                Close
              </button>
            </div>
          </div>
