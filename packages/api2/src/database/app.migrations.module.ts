...
@Module({
  imports: [
    MongooseModule.forRoot(
      `mongodb://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@${process.env.MONGO_HOST}:${process.env.MONGO_PORT}/${MAIN_DB_NAME}?authSource=admin&appname=Migrations`,
    ),
    ActivateModule,
    ApiKeyModule,
    AuthModule,
