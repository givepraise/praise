...
describe('Communities (E2E)', () => {
  ...
  describe('POST /api/communities/temp', () => {
    //TODO after migrating all communities and removing this endpoint this test should be removed
    const hostname = 'test-community';
