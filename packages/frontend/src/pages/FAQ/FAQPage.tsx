                ...
                {data.questions.map((item, i) => {
                  return (
                    <Disclosure defaultOpen={false} as="div" key={i}>
                      {({ open }): JSX.Element => (
                        <>
                          <Disclosure.Button className="flex justify-between w-full px-4 py-2 mb-2 font-medium text-left bg-warm-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none">
