                ...
                <div className="mb-2">
                  ...
                  >
                    <input
                      ...
                      className="relative left-[-5px] pl-1 w-1/2 text-xl font-semibold bg-transparent border border-transparent dark:border-transparent hover:border-gray-300 dark:hover:border-slate-800 dark:bg-transparent"
                      onKeyDown={(e): void => {
                        switch (e.key) {
                          case 'Tab':
                            void handleSubmit();
